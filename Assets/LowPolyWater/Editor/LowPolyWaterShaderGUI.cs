...
public class LowPolyWaterShaderGUI : ShaderGUI {
    ...
    public void FindProperties(MaterialProperty[] props) {
        ...
        __RHeight = FindProperty("__RHeight", props);
        __RSpeed = FindProperty("__RSpeed", props);
        __TexSize = FindProperty("__TexSize", props);
        __Speed = FindProperty("__Speed", props);
        __Height = FindProperty("__Height", props);
    }
